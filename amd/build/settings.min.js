...
/**
   ...
   **/Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.default=void 0,_notification=_interopRequireDefault(_notification),_log=_interopRequireDefault(_log);var _default={init:function(){const el=document.getElementById("id_s_local_commander_keys");el&&((0,_str.get_string)("js:keycode_help","local_commander").then((message=>{el.insertAdjacentHTML("beforebegin",'\n                <div class="alert alert-info" id="key-monitor">\n                    <b>'.concat(message,"</b>\n                    <div></div>\n                </div>\n            "))})).catch(_notification.default.exception),document.addEventListener("keydown",(e=>{const tagName=e.target.tagName.toUpperCase();if("INPUT"===tagName||"SELECT"===tagName||"TEXTAREA"===tagName||e.target.isContentEditable)return void _log.default.debug("Key event ignored in editable element");const keyboardCode=e.keyCode||e.which,monitorDiv=document.querySelector("#key-monitor div");monitorDiv&&(monitorDiv.textContent="key = ".concat(e.key," | code = ").concat(keyboardCode))})))}};return _exports.default=_default,_exports.default}));
